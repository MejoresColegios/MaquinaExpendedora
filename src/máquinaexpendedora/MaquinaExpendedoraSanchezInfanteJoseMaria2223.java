...
public class MaquinaExpendedoraSanchezInfanteJoseMaria2223 {// Consideramos máquina snack precio único
    private int unidades;//número de snacks disponbles en la máquina expendora 
    private double precio;//precio actual de un snack
    private double precio_maxSanchezInfanteJoseMaria2223;//precio máximo que puede tener un  snack

    /*Constructor por defecto*/
    public MaquinaExpendedoraSanchezInfanteJoseMaria2223() {
    
    }
    
    
     /*Constructor por parámetros*/
    public MaquinaExpendedoraSanchezInfanteJoseMaria2223(int unidades, double precio, double precio_max) {
        this.unidades = unidades;
        this.precio = precio;
        this.precio_maxSanchezInfanteJoseMaria2223 = precio_max;
    }
    ...
    public void aumentarPrecio(double aumento) throws Exception {
        ...
        if (getPrecio_maxSanchezInfanteJoseMaria2223() < getPrecio() + aumento) {
...
suficientes unidades en la máquina*/
    public void sacarsnack(int unidades, double dinero, String regaloSanchezInfanteJoseMaria2223) throws Exception {
        if (dinero <= 0) {
    ...
    /**
     * @return the precio_maxSanchezInfanteJoseMaria2223
     */
    public double getPrecio_maxSanchezInfanteJoseMaria2223() {
        return precio_maxSanchezInfanteJoseMaria2223;
    }

    /**
     * @param precio_maxSanchezInfanteJoseMaria2223 the precio_maxSanchezInfanteJoseMaria2223 to set
     */
    public void setPrecio_maxSanchezInfanteJoseMaria2223(double precio_maxSanchezInfanteJoseMaria2223) {
        this.precio_maxSanchezInfanteJoseMaria2223 = precio_maxSanchezInfanteJoseMaria2223;
    }
